...
FROM '/Users/donaldhighe/code/wdi/labs/movies/db/seed_data/ratings.data' with (format csv, delimiter E'\t');
...
-- UPDATE THIS PATH WITH YOUR OWN!
FROM '/Users/donaldhighe/code/wdi/labs/movies/db/seed_data/users.data' with (format csv, delimiter '|');
...
-- UPDATE THIS PATH WITH YOUR OWN!
FROM '/Users/donaldhighe/code/wdi/labs/movies/db/seed_data/movies.data' with (format csv, delimiter '|');
